...
#########################################
#from jupiter.strategies.strategy_afternoon_cont_vwap import AfternoonContVwapStrategy as TestStrategy
#from jupiter.strategies.strategy_afternoon_long_s1 import AfternoonLongS1Strategy as TestStrategy
from jupiter.strategies.strategy_afternoon_long_s1 import AfternoonLongS1Strategy as TestStrategy

# Define parameter grid for optimization
param_grid = {
    'size': [100],
    #'dmi_period': [14, 20, 25, 30, 35, 40, 45, 50, 60],
...
#todate = date(2023, 2, 15) # for quick testing
...
def main():
    ...
    print(f"\nRunning with best parameters found: {best_params}")
    ...
    #create_excel_pivot_native(pivot_params=pivot_params)
